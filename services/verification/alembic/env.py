...
ABOUTME: Handles database connection and migration execution for JuraGPT Auditor

This file is loaded by Alembic to configure the migration environment.
It sets up the database connection, loads models, and runs migrations.
"""
...
# Add parent directory to path to import auditor modules
